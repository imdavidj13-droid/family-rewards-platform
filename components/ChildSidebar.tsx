...
export default function ChildSidebar({ child }: { child: any }) {
  ...
  return (
    <aside
  className="min-h-screen w-56 shrink-0 overflow-hidden border-r-4 border-yellow-900 text-yellow-100 shadow-2xl"
  style={{
    backgroundImage: "url('/images/pirate/sidebar-bg.png')",
      ...
      >
        ...
        <span
          className={`relative z-10 text-2xl font-black ${
            link.active ? "text-yellow-100" : "text-yellow-200"
          }`}
        >
          {link.label}
        </span>
